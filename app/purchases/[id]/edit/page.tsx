      ...
      <div className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
        <Card className="w-full max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>L'achat que vous essayez de modifier n'existe pas.</CardDescription>
          </CardHeader>
        </Card>
      </div>
    )
  ...
  return (
    <div className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
      <Card className="w-full max-w-2xl mx-auto">
        ...
        <CardContent>
          <PurchaseForm action={updatePurchase} initialData={purchase} suppliers={suppliers} />
        </CardContent>
      </Card>
    </div>
  )
