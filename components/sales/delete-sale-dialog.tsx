...
export default function DeleteSaleDialog({ saleId, isOpen, onClose }: DeleteSaleDialogProps) {
  ...
  const handleDelete = async () => {
    ...
    if (result.message) {
      ...
      toast.error("Échec de la suppression de la vente.", {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            et ajustera le stock du produit.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
