...
-- and `complete_supabase_schema.sql` have been executed.

-- Check if products already exist to prevent duplicates on re-run
...
ON CONFLICT (name) DO NOTHING; -- Prevents inserting duplicates if name is unique
