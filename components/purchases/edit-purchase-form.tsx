...
export function EditPurchaseForm({ initialData, suppliers, products }: EditPurchaseFormProps) {
  ...
  const [purchaseDate, setPurchaseDate] = useState<Date | undefined>(new Date(initialData.purchase_date))
